      ...
      <ul className="flex justify-between items-center gap-6 mx-4">
        <li className="flex justify-center items-center gap-2">
          <div className="contain w-[30px] h-[30px]">
            <img
              src="https://cdn.worldvectorlogo.com/logos/zoom-app.svg" // Logo of the meeting does here...
              alt="Zoom Logo" // Name of the meeting app goes here...
            />
          </div>
